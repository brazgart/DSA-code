...
public class ExprDriver 
{
  ...
  {   System.out.println ("\n\nTesting part (a)");
      ...
      e2 = new Mod (new Constant(75), new Product (e1, new Constant(3)));     
      System.out.println (e2 + " simplifies to " + e2.simplify());
      System.out.println (e2 + " = " + e2.eval());
      
      e1 = new Sum(new Sum (new Variable('v'), new Constant(5)),(new Sum (new Variable('v'), new Constant(5))));       //  (v + 5)+ (v+5) 
